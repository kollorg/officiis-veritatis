# @kollorg/officiis-veritatis - Version 2

![Tests](https://github.com/kollorg/officiis-veritatis/workflows/Test%20PR/badge.svg)
...
**Note:  @kollorg/officiis-veritatis is now an ESM by default package** - this is a good thing, but does require some breaking changes.
...
```ts
import { Base91, Graphviz, Zstd } from "@kollorg/officiis-veritatis";
...
v1.x.x
```ts
import { graphviz, wasmFolder } from "@kollorg/officiis-veritatis";

wasmFolder("https://cdn.jsdelivr.net/npm/@kollorg/officiis-veritatis/dist");
...
v2.x.x
```ts
import { Graphviz } from "@kollorg/officiis-veritatis";
